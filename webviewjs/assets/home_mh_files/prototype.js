...
var $A = Array.from = function(iterable) {
   ...
   if (iterable.toArray) {
      ...
      var results = [];
      for (var i = 0, length = iterable.length; i < length;
      i++)
...
Object.extend(Hash.prototype, {
   ...
   remove: function() {
      var result;
      for(var i = 0, length = arguments.length; i < length;
      i++) {
...
Ajax.Request.prototype = Object.extend(new Ajax.Base(), {
   ...
   initialize: function(url, options) {
	  ...
	  //alert(" this.transport:"+ this.transport);
   ...
   setRequestHeaders: function() {
      ...
      if (typeof this.options.requestHeaders == 'object') {
         ...
         for (var i = 0, length = extras.length; i < length;
         i += 2)
...
//  ---------------------------------------
   ...
   var elements = [], child;
   for (var i = 0, length = children.length; i < length;
   i++) {
      child = children[i];
...
Element.extend = function(element) {
   ...
   , tagName = element.tagName, cache = Element.extend.cache,
...
Object.extend(Selector, {
   ...
   handlers: {
      ...
      child: function(nodes) {
         ...
         for (var i = 0, results = [], node; node = nodes[i];
         i++) {
            for (var j = 0, children = [], child; child = node.childNodes[j];
            j++)
   ...
   matchElements: function(elements, expression) {
      ...
      h.mark(matches);
      for (var i = 0, results = [], element; element = elements[i];
      i++)
